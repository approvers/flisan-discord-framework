...
import example.Caller
import test.EnterEventListener
import test.Tester
...
fun main() {
    ...
    // クライアントにコマンドを登録します。
    client.addMessageCommand(Tester())            // https://github.com/approvers/jubilant/blob/dev/src/test/kotlin/test/Tester.kt
